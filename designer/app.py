...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        #vip
        self.setupUi(self)
        self.pushButton.clicked.connect(self.add_stuff) #push button to make new windows appear
        self.done = [] #keep track of tasks one
        self.not_done = [] #keep track of tasks that need to be completed
    ...
    def undo_task(self):
        task = self.finished_list.takeItem(self.finished_list.currentRow())#ramining list and takes item from row a returns back to task
